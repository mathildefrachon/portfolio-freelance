var nsOptions = {
  ...
  aspectRatio: "?:90%", // "?:100%" is for responsive scaling based on window height
...
function NinjaSlider(a) {
  ...
  var Wb = function(a) {
    ...
    Lb = function() {
      ...
      q(
        " li.loading::after{content:'';display:none;position:absolute;width:30px;height:30px;border-width:4px;border-color:rgba(255,255,255,.8);border-style:solid;border-top-color:black;border-right-color:rgba(0,0,0,.8);border-radius:50%;margin:auto;left:0;right:0;top:0;bottom:0;}"
      );
    },
    Bb = function() {
      var a = "#" + t + "-prev:after",
